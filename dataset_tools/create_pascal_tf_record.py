...
flags.DEFINE_string('output_path', OUTPUT_DIR, 'Path to output TFRecord')
flags.DEFINE_string('label_map_path', LABEL_MAP_PATH, 'Path to label map proto')
...
def dict_to_tf_example(data,
    ...
    """Convert XML derived dict to tf.Example proto.
      ...
      Args:
        data: dict holding PASCAL XML fields for a single image (obtained by
          running dataset_utils.recursive_parse_xml_to_dict)
  ...
  """
    ...
    example = tf.train.Example(features=tf.train.Features(feature={
        ...
        'image/object/difficult': dataset_utils.int64_list_feature(difficult_obj),
        'image/object/truncated': dataset_utils.int64_list_feature(truncated),
        'image/object/view': dataset_utils.bytes_list_feature(poses),
    }))
    return example
